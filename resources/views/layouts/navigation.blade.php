        ...
        <div class="flex justify-between h-16">
            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6 space-x-4">
                ...
                <button
                    ...
                    class="px-3 py-1 text-sm rounded bg-gray-200 text-gray-800 dark:bg-gray-700 dark:text-white transition"
                    x-text="document.documentElement.classList.contains('dark') ? 'Light Mode' : 'Dark Mode'"
                ></button>
                        ...
                        <button class="inline-flex items-center px-3 py-2 border border-transparent text-sm leading-4 font-medium rounded-md text-gray-500 dark:text-gray-400 bg-white dark:bg-gray-800 hover:text-gray-700 dark:hover:text-gray-300 focus:outline-none transition ease-in-out duration-150">
                            <div>
                                ...
                                @if(auth()->user()->is_admin)
                                    <span class="text-xs bg-red-500 text-white px-2 py-0.5 rounded ms-2">Admin</span>
                                @endif
                            </div>
                            <div class="ms-1">
